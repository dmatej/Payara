 ...
 * ./runme-local.sh -Ptest-containers -pl :test-containers -Ddocker.payara.version=5.202-SNAPSHOT -Ddocker.payara.tag=5.202-4176 -Dit.test=JaspicSamAuthenticationITest
 * ./runme-local.sh -Ptest-containers -pl :test-containers -Ddocker.payara.version=5.202-SNAPSHOT -Ddocker.payara.tag=5.202-SNAPSHOT -Ddocker.payara.cfg.logging.newImplementation=false -Dit.test=JaspicSamAuthenticationITest
 * </pre>
 */
// CUSTCOM-133
